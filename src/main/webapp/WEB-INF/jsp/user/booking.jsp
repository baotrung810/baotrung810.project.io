<%-- 
    Document   : booking
    Created on : Jul 2, 2019, 4:53:33 PM
...
<html>
    ...
    <body>
                        ...
                        <div class="booking_slider_container">
                            <div class="owl-carousel owl-theme booking_slider">
                                ...
                                <div class="booking_item">
                                    <div class="background_image" style="background-image:url(reception/resources/images/booking_1.jpg)"></div>
                                ...
                                <!-- Slide -->
                                <div class="booking_item">
                                    <div class="background_image" style="background-image:url(reception/resources/images/booking_2.jpg)"></div>
                                    <div class="booking_overlay trans_200"></div>
                                    <div class="booking_item_content">
                                        <div class="booking_item_list">
                                            <ul>
                                ...
                                <!-- Slide -->
                                <div class="booking_item">
                                    <div class="background_image" style="background-image:url(reception/resources/images/booking_3.jpg)"></div>
                                    <div class="booking_overlay trans_200"></div>
                                    <div class="booking_item_content">
                                        <div class="booking_item_list">
                                            <ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="details_image">
                            <div class="background_image" style="background-image:url(reception/resources/images/details_1.jpg)"></div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6 order-lg-2 order-1">
                        <div class="details_image">
                            <div class="background_image" style="background-image:url(reception/resources/reception/resources/images/details_2.jpg)"></div>
                        </div>
                    </div>
        ...
        <div class="special">
            <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="reception/resources/images/special.jpg" data-speed="0.8"></div>
            <div class="container">
                <div class="row">
