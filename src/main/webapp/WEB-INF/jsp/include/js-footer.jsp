...
<script src="<c:url value="/resources/plugins/OwlCarousel2-2.3.4/owl.carousel.js"/>"></script>
...
<script src="<c:url value="/resources/plugins/jquery-datepicker/jquery-ui.js"/>"></script>
